...
## Project Structure
    ...
    ├── testapiautoconnect_113465  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_113465`
...
2. Clone this repo and `cd testapiautoconnect_113465`
